...
요즘은 venv 등을 이용해 파이썬 환경에서 가볍고 빠르게 가상 환경을 구축할 수 있지만, 이번에는 패키지뿐 아니라 시스템 라이브러리까지 함께 관리할 수 있어서 예전부터 많이 사용되었던 conda를 알아보자. conda를 이용해 가상 환경을 만들고 관리하는 방법을 정리해보도록 하겠다.
