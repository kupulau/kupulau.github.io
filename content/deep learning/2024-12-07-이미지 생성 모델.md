...
tags:
  - genAI
url: https://velog.io/@kupulau/이미지-생성-모델
created_at: 2024-12-07
related_notes:
---

\* 생성 모델에 대한 기초적인 내용은 [[2024-09-03-generative models|여기]]를 참조하자.
...
따라서 두 분포의 [[2024-12-07-Kullback-Leibler divergence|KL divergence]] 값을 구하면 inception score를 계산할 수 있는데, inception score 값이 클수록 두 분포가 다르다는 것을 의미하므로 이미지가 잘 생성되는 것으로 평가할 수 있다. 
